          ...
          <Collapse accordion>
            <Panel header='How can I track my order status?' key='1'>
              <p className='text-gray-600 dark:text-gray-400'>
                ...
                number to check your order&apos; status. Simply visit the Track
                Order section on our website and input your tracking number to
            ...
            <Panel header='What payment methods do you accept?' key='2'>
              <p className='text-gray-600 dark:text-gray-400'>
                ...
                and debit cards such as Visa, MasterCard, and American Express.
                Additionally, we offer secure payment gateways for digital
            ...
            >
              <p className='text-gray-600 dark:text-gray-400'>
                ...
                your personal information. Your data is always handled with the
                utmost care. You can read more about our security practices in
                our Privacy Policy.
              </p>
            </Panel>
            <Panel
            ...
            >
              <p className='text-gray-600 dark:text-gray-400'>
                Absolutely, we stand by the quality of our products. Many items
                come with manufacturer warranties. You can find details about
                warranties and guarantees on the product page. If you encounter
                any issues, please contact our customer support for assistance.
              </p>
            </Panel>
            <Panel header='What is your return policy?' key='5'>
              <p className='text-gray-600 dark:text-gray-400'>
                We want you to be satisfied with your purchase. If you're not
                completely happy, we offer a hassle-free return policy. You can
                initiate a return within 30 days of receiving your order. Please
            ...
            >
              <p className='text-gray-600 dark:text-gray-400'>
                ...
                questions, help with issues, and ensure your shopping experience
                is enjoyable.
              </p>
            </Panel>
          </Collapse>
